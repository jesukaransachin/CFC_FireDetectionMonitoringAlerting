...
public class IoTPagerFragment extends IoTStarterPagerFragment {
    ...
    private void initializeIoTActivity() {
        ...
        updateViewStrings();
        final IoTStarterApplication app = (IoTStarterApplication)getActivity().getApplicationContext();
        ...
        Button buttonNoFire = (Button) getActivity().findViewById(R.id.btnnormal);
        buttonNoFire.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                app.setFireType(0);
            }
        ...
        Button buttonFire = (Button) getActivity().findViewById(R.id.btnfire);
        ...
        Button buttonHighFire = (Button) getActivity().findViewById(R.id.btnheavyfire);
        buttonHighFire.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                app.setFireType(2);
            }
