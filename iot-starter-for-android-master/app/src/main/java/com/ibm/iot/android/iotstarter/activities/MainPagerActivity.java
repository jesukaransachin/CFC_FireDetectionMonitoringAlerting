...
import com.ibm.iot.android.iotstarter.GetDataService;
import com.ibm.iot.android.iotstarter.IoTStarterApplication;
import com.ibm.iot.android.iotstarter.R;
import com.ibm.iot.android.iotstarter.RetrofitClientInstance;
import com.ibm.iot.android.iotstarter.WeatherData;
...
public class MainPagerActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {// Check permission
             ActivityCompat.requestPermissions(this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, REQUEST_LOCATION);
        }

        ((IoTStarterApplication)getApplicationContext()).callAsynchronousWeatherTask();
